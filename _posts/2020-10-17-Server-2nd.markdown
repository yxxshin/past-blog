...
![Thread](https://imgur.com/xKdGwDn.jpg)
<br>
...
Node는 이벤트 리스너(Event Listener)에 콜백 함수를 지정해서 동작한다. <center><img src="https://imgur.com/ljqZiB9.jpg" width="250"></center>
(부가적인 설명)  
...
- **CallStack (호출 스택)**  
코드가 실행되면 호출 스택이 쌓인다.  
프로그램에서 우리가 어딨는지를 기록하는 데이터 구조!<center><img src="https://imgur.com/mATyqGw.jpg" width="230"></center><center><img src="https://imgur.com/Lk2niZG.jpg" width="230"></center>
